...
| Module | Topic | Problem It Solves | Guide |
|--------|-------|-------------------|-------|
| 1 | [FastAPI + Docker](1_FastAPI_Docker_demo/) | Serving a trained model as a production API | [article.md](1_FastAPI_Docker_demo/article.md) |
