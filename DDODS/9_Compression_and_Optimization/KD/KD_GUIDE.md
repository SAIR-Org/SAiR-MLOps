...
Demo: `kd.ipynb` — training a tiny MLP student (16 K params) from a CNN teacher (1.2 M params) on MNIST using soft-target distillation. 75× compression, 93.3% accuracy vs teacher's 98.7%.
